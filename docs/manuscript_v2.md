...
### 4. Lexicon: 14 roots grounded in NSM

Roots are justified against the Natural Semantic Metalanguage primes (Wierzbicka, 1996; Goddard, 2018):
...
With 14 phonemes and concatenation, the count of distinct expressions of length n is 14ⁿ (modulo phonotactic filters):

- n=1: 14 (roots)
- n=2: 196
- n=3: 2,744
- Σ(n≤3): **2,954** expressions

Toki Pona's ~120-word lexicon maps onto n≤3 expressions with >20× redundancy — ample for disambiguation. The zero-sign 0 introduces clause-level structure (up to 2,954 expressions per clause boundary). Thus the one-phoneme constraint does not limit expressivity below Toki Pona's practical range, at the cost of ambiguity resolved by context (as in Toki Pona itself).
...
1. Chirikba, V. A. (2003). *Abkhaz*. Lincom Europa.
2. Colombo, L., et al. (2024). How learning Toki Pona may help improving communication strategies in cross-cultural encounters. *Language Problems and Language Planning*. https://doi.org/10.1075/lplp.00086.col
...
4. Fenwick, R. S. H. (2011). *A grammar of Ubykh*. Lincom Europa.
5. Goddard, C. (2018). *Ten lectures on Natural Semantic Metalanguage*. Brill. https://doi.org/10.1163/9789004357723
6. Lang, S. (2014). *Toki Pona: The language of good*. Tawhid.
7. Maddieson, I. (1984). *Patterns of sounds*. Cambridge University Press. https://doi.org/10.1017/CBO9780511753459
8. Maddieson, I. (2013). Consonant inventories. In M. S. Dryer & M. Haspelmath (Eds.), *The world atlas of language structures online*. Max Planck Institute. https://wals.info/chapter/1
9. Ogden, C. K. (1930). *Basic English: A general introduction with rules and grammar*. Kegan Paul.
10. Parker Jones, Ō. (2017). Hawaiian. *Journal of the International Phonetic Association, 48*(2), 185–191. https://doi.org/10.1017/S0025100316000438
11. Prince, A., & Smolensky, P. (2004). *Optimality theory: Constraint interaction in generative grammar*. Blackwell. https://doi.org/10.1002/9780470759400
12. Robinson, S. (2006). The phoneme inventory of the Aita dialect of Rotokas. *Oceanic Linguistics, 45*(1), 206–209. https://doi.org/10.1353/ol.2006.0018
13. Shosted, R. K., & Chikovani, V. (2006). Standard Georgian. *Journal of the International Phonetic Association, 36*(2), 255–264. https://doi.org/10.1017/S0025100306002659
14. Whorf, B. L. (1956). *Language, thought, and reality: Selected writings*. MIT Press.
15. Wierzbicka, A. (1996). *Semantics: Primes and universals*. Oxford University Press.

---

### Figure 1 (placeholder — conceptual diagram)

Schematic: [Minimal inventory (11–14, UPSID)] → [აი 14 phonemes] → [14 NSM-grounded roots] → [composition 14ⁿ] → [Georgian 1:1 orthography + 0-pause]. All levels in a single visual.
