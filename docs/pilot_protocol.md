...
3. **Stimuli C (acquisition, H3):** lesson slides (2 × 30 min: phonology 10 min, roots 30 min, composition 20 min), recall test (20 items: 10 production, 10 comprehension) at 48 h.
4. **Questionnaire:** demographics (age, gender, L1, L2s, education), language attitudes (Likert).
